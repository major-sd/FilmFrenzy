...
class Admin(db.Model, UserMixin):
    ...
    admin_username = db.Column(db.String(100), db.ForeignKey('user.id'), nullable=False, unique=True)
    admin_password = db.Column(db.String(200), db.ForeignKey('user.id'), nullable=False)
